...
import static com.makemysketch.app.R.id.fab;
...
public class ItemDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bd != null) {
            ...
            if (type.equals("Framed")) {
                RadioButton radioButton = (RadioButton) findViewById(R.id.unframed);
                radioButton.setVisibility(View.INVISIBLE);
                RadioButton radioButton2 = (RadioButton) findViewById(R.id.framed);
                radioButton2.setText("Pre-Framed");
